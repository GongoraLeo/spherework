                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form method="POST" action="{{ route('libros.store') }}">
                        ...
                        <div class="mb-4">
                            ...
                            {{-- AÑADIDO: dark:text-gray-400 para mejorar visibilidad en modo oscuro --}}
                            <x-text-input id="titulo" class="block mt-1 w-full dark:text-gray-400" type="text" name="titulo" :value="old('titulo')" required autofocus />
                        ...
                        <div class="mb-4">
                            ...
                            {{-- AÑADIDO: dark:text-gray-400 para mejorar visibilidad en modo oscuro --}}
                            <x-text-input id="isbn" class="block mt-1 w-full dark:text-gray-400" type="text" name="isbn" :value="old('isbn')" required />
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            ...
                            <div>
                                ...
                                {{-- AÑADIDO: dark:text-gray-400 para mejorar visibilidad en modo oscuro --}}
                                <x-text-input id="anio_publicacion" class="block mt-1 w-full dark:text-gray-400" type="number" name="anio_publicacion" :value="old('anio_publicacion')" required min="1000" :max="date('Y')" />
                            ...
                            <div>
                                ...
                                {{-- AÑADIDO: dark:text-gray-400 para mejorar visibilidad en modo oscuro --}}
                                <x-text-input id="precio" class="block mt-1 w-full dark:text-gray-400" type="number" name="precio" :value="old('precio')" required step="0.01" min="0" />
                        ...
                        <div class="mb-4">
                            ...
                            {{-- CAMBIADO: dark:text-gray-300 a dark:text-gray-400 --}}
                            <select id="autor_id" name="autor_id" required class="block mt-1 w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-400 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm">
                        ...
                        <div class="mb-4">
                            ...
                            {{-- CAMBIADO: dark:text-gray-300 a dark:text-gray-400 --}}
                            <select id="editorial_id" name="editorial_id" required class="block mt-1 w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-400 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm">
