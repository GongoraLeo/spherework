{{-- filepath: resources/views/admin/editoriales/edit.blade.php --}}
            ...
            <div class="max-w-xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900 dark:text-gray-100">
                        ...
                        <h1 class="text-2xl font-semibold mb-6">Editar Editorial: {{ $editoriales->nombre }}</h1>
                        ...
                        {{-- Ruta verificada: admin.editoriales.update --}}
                        <form method="POST" action="{{ route('admin.editoriales.update', $editoriales) }}">
                            @csrf
                            @method('PUT') {{-- O PATCH --}}
                            ...
                            <div class="mb-4">
                                ...
                                <input id="nombre"
                                       ...
                                       type="text"
                                       name="nombre"
                                       value="{{ old('nombre', $editoriales->nombre) }}" {{-- Usa $editoriales --}}
                                       required
                                       autofocus />
                            ...
                            <div class="mb-4">
                                ...
                                <input id="pais"
                                       ...
                                       type="text"
                                       name="pais"
                                       value="{{ old('pais', $editoriales->pais) }}" {{-- Usa $editoriales --}}
                                       required />
